...
- Decision: **warning**
- Generated: 2026-06-10T10:50:01.391Z
...
- Decision: **warning**
- Generated: 2026-06-10T10:50:01.384Z
...
- Baselines passing: 6
- Comparison samples passing: 4/4
- Comparison dimension coverage: 4/6 (incomplete)
- Comparison dimensions passing: 4/6
...
- **route_differentiation**: baseline=PASS, comparison=FAIL (uncovered), indicator=OK — baseline Δ=0.105; no comparison sample (required); gap=-0.042 aligned
- **late_game_payoff**: baseline=PASS, comparison=FAIL (uncovered), indicator=OK — baseline Δ=0.254; no comparison sample (required); gap=0.008 aligned
...
- Strong dimensions preserved: false
