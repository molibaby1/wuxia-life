...
- [产品决策](governance/product-decisions.md)：长期 Product Decisions；Auto Evolution 当前方向重点见 PD-055、PD-062、PD-063；Character / Relationship、Sex-Variant Person Archetype、Parenthood、Generic Relationship Legacy Quarantine、Content Authoring Workflow、Person Domain Authoring consolidation、Life Milestone Domain & Feedback v2、Canonical Setback Occurrence / Resolution Ownership、Active Formal Random Trigger Retirement、Bounded Causal Attribution Evidence Handoff 与 Bounded Identity-Year Practice Duration 的 current authority closure 见 PD-101 / PD-103 / PD-102 / PD-104 / PD-106 / PD-107 / PD-108 / PD-109 / PD-110 / PD-111 / PD-114。
