...
const suites: Suite[] = [
  ...
  { name: 'canonicalBirthBackground', entry: 'tests/canonicalBirthBackground.test.ts' },
  ...
  {
    name: 'choiceFeedbackCanonicalPublicDeltaParity',
    entry: 'tests/choiceFeedbackCanonicalPublicDeltaParity.test.ts',
  },
  ...
  { name: 'characterRelationshipMingyueV1', entry: 'tests/characterRelationshipMingyueV1.test.ts' },
  { name: 'characterRelationshipMarriageV1', entry: 'tests/characterRelationshipMarriageV1.test.ts' },
  { name: 'characterRelationshipSaiyinV1', entry: 'tests/characterRelationshipSaiyinV1.test.ts' },
  { name: 'introducedMarriageShenQingheV1', entry: 'tests/introducedMarriageShenQingheV1.test.ts' },
  { name: 'choiceIdExecutionClosure', entry: 'tests/choiceIdExecutionClosure.test.ts' },
  { name: 'sexVariantPersonArchetypeV1', entry: 'tests/sexVariantPersonArchetypeV1.test.ts' },
  { name: 'parenthoodMingyueV1', entry: 'tests/parenthoodMingyueV1.test.ts' },
  ...
  { name: 'humanReviewSummary', entry: 'tests/evolution/humanReviewSummary.test.ts' },
  { name: 'ordinaryEvolutionOperator', entry: 'tests/evolution/ordinaryEvolutionOperator.test.ts' },
  { name: 'multiRoundSessionObservability', entry: 'tests/evolution/multiRoundSessionObservability.test.ts' },
