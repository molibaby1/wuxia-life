...
export const P25_PINNACLE_LIFE_PATHS: LifePathFixture[] = [
  {
    ...
    player: { age: 40, martialPower: 98, reputation: 80, connections: 30 },
  ...
  },
  {
    ...
    label: '武林神话·有机缘缺护道誓',
    originId: 'martial_family',
    player: { age: 38, martialPower: 96, reputation: 78, connections: 25 },
  ...
  },
  {
    ...
    player: { age: 42, martialPower: 75, reputation: 60, connections: 75 },
  ...
  },
  {
    ...
    player: { age: 41, martialPower: 72, reputation: 55, connections: 72 },
  ...
  },
  {
    ...
    label: '武林神话·双门槛齐',
    originId: 'martial_family',
    player: { age: 39, martialPower: 97, reputation: 78, connections: 20 },
  ...
  },
  {
    ...
    label: '开派祖师·双门槛齐',
    originId: 'scholar_house',
    player: { age: 43, martialPower: 74, reputation: 58, connections: 72 },
