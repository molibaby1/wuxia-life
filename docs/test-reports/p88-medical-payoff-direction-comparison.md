...
**关于放弃方向的说明：**
因本阶段需要为每个 variant 选定正好 3 个 payoff choice，3 个候选均满足质量门槛和 boundedness 要求，故全部入选，无放弃方向。3 个方向形成完整三角（硬扛/放手/平衡），覆盖了玩家的主要选择心理。在 3 个候选之外，也曾评估过"转做药材生意"（放弃行医，商业化）等方向，但因偏离 compassionate variant 的"仁心"核心主题、tavern-born 风味弱、与 merchant 路线区分度不足而未进入候选池。
...
**关于放弃方向的说明：**
因本阶段需要为每个 variant 选定正好 3 个 payoff choice，3 个候选均满足质量门槛和 boundedness 要求，故全部入选，无放弃方向。3 个方向形成完整三角（硬扛/放手/平衡），覆盖了玩家的主要选择心理。在 3 个候选之外，也曾评估过"投靠某一门派"（彻底依附权势）等方向，但因丢失了"行医"的核心身份、tavern-born 风味弱、场景过于 generic 江湖而未进入候选池。
