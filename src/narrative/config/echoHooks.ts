...
export const WUXIA_ECHO_HOOKS: EchoHook[] = [
  ...
  },
  {
    ...
    callbackEventId: 'p9_merchant_midlife_caravan',
    callbackAgeMin: 28,
    callbackAgeMax: 30,
    ...
    summaryContribution: {
      ...
      variableName: 'echo_suffix',
      order: 15,
      textSources: [{ kind: 'flag_value', flagKey: 'p9_summary_echo_business' }, { kind: 'description' }],
    },
    description: '幼年营商 → 商路初成',
    authoringContract: {
      requiredCompanionFiles: [
        'src/data/activeActionCatalog.ts',
        'src/data/lines/p9-remediation.json',
      ],
      triggerSemantics: 'action_business_basic.onCompleteFlags sets p9_echo_business_hook',
      callbackConditionPattern: 'flags.has("p9_echo_business_hook")',
      llmEditableFields: ['description', 'callbackAgeMin', 'callbackAgeMax'],
    },
  },
  {
    ...
    summaryContribution: {
      ...
      variableName: 'echo_suffix',
      order: 16,
      textSources: [{ kind: 'flag_value', flagKey: 'p9_summary_echo_travel' }, { kind: 'description' }],
    },
    ...
    authoringContract: {
      ...
      triggerSemantics: 'action_travel_basic.onCompleteFlags sets p9_echo_travel_hook',
      callbackConditionPattern: 'flags.has("p9_echo_travel_hook")',
      llmEditableFields: ['description', 'callbackAgeMin', 'callbackAgeMax'],
    },
  },
  {
