...
- [Experience Measurement Contract v1](product/experience-measurement-contract-design.md)：PD-105 Human-accepted 的正式事件节奏测量、semantic calibration、legacy repetition diagnostic 与 `REPORT_ONLY` 边界。
