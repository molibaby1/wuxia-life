...
export const P25_REPRESENTATIVE_LIFE_PATHS: LifePathFixture[] = [
  {
    ...
    player: { age: 35, martialPower: 85, reputation: 55, connections: 40 },
    flags: {
      route_orthodox: true,
  ...
  },
  {
    ...
    player: { age: 40, martialPower: 35, reputation: 60, connections: 25 },
    flags: {
  ...
  },
  {
    ...
    player: { age: 42, martialPower: 60, reputation: 50, connections: 65 },
  ...
  },
  {
    ...
    player: { age: 36, martialPower: 92, reputation: 40, connections: 15 },
...
export const P30_HABIT_LED_LIFE_PATHS: LifePathFixture[] = [
  {
    ...
    flags: {
      p28_social_network_opened: true,
