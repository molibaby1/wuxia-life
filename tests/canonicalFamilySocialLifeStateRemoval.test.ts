...
function testSnapshot380Boundary(): void {
  assert(GAME_STATE_SNAPSHOT_SCHEMA_VERSION === '3.15.0', 'Snapshot schema must be 3.15.0');
  ...
  assert(!validateGameStateSnapshot(missingLifeStates).ok, '3.15.0 snapshot must require lifeStates');
