  ...
  state: {
    ...
    routeStates: {
      hero: {
        ...
        lockedIn: true,
        lastChangedAtAge: 28,
        sourceEventId: 'hero_origin_01',
        reason: 'accepted_hero_path',
      },
      merchant: {
        routeId: 'merchant',
        lifecycle: 'inactive',
      ...
      scholar: {
        ...
        lockedIn: false,
        lastChangedAtAge: 45,
        sourceEventId: 'scholar_study_complete_01',
        reason: 'completed_study_commitment',
      },
    },
    routeHistory: [
      {
        ...
        age: 16,
        eventId: 'youth_sect_choice_01',
        timestamp: FIXTURE_CREATED_AT + 1000,
      },
      {
        routeId: 'hero',
        from: 'temporary',
        ...
        eventId: 'hero_origin_01',
        reason: 'accepted_hero_path',
        timestamp: FIXTURE_CREATED_AT + 2000,
      },
      {
        routeId: 'hero',
        from: 'active',
        ...
        lockedIn: true,
        age: 35,
        eventId: 'hero_commitment_01',
        reason: 'swore_to_protect_weak',
        timestamp: FIXTURE_CREATED_AT + 3000,
      },
      {
        routeId: 'scholar',
        from: 'inactive',
        ...
        lockedIn: false,
        age: 40,
        timestamp: FIXTURE_CREATED_AT + 4000,
      },
      {
        routeId: 'scholar',
        from: 'active',
        ...
        lockedIn: false,
        age: 45,
        eventId: 'scholar_study_complete_01',
        timestamp: FIXTURE_CREATED_AT + 5000,
      },
    ],
    lifePath: {
