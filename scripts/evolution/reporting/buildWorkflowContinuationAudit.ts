...
const SOLUTION_ROUTES: readonly SolutionDecisionV1['route'][] = ['READY_FOR_CONFIG_EXECUTION', 'SKIP', 'DEFER', 'DEFER_MORE_WORK_REQUESTED', 'ESCALATE_HUMAN'];
const DECISION_REASONS: readonly SolutionDecisionV1['reasonCode'][] = ['ACCEPTED_CONFIGURATION_SCOPE', 'ACCEPTED_REQUIRES_HUMAN_AUTHORITY', 'EXECUTION_AUTHORITY_UNCERTAIN', 'ACCEPTED_OUT_OF_SCOPE', 'NO_PROBLEM_FORMED', 'NO_PROPOSAL', 'INSUFFICIENT_EVIDENCE', 'REVIEW_REJECTED', 'REVIEW_ACCEPT_NO_ACTION', 'REVIEW_REQUEST_MORE_WORK', 'REVIEW_DEFERRED', 'EXPLICIT_ESCALATION', 'PARTICIPANT_FAILURE'];
