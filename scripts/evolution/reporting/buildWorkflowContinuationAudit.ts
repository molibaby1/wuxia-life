...
const DECISION_REASONS: readonly SolutionDecisionV1['reasonCode'][] = ['ACCEPTED_CONFIGURATION_SCOPE', 'ACCEPTED_OUT_OF_SCOPE', 'NO_PROBLEM_FORMED', 'NO_PROPOSAL', 'INSUFFICIENT_EVIDENCE', 'REVIEW_REJECTED', 'REVIEW_ACCEPT_NO_ACTION', 'REVIEW_REQUEST_MORE_WORK', 'REVIEW_DEFERRED', 'EXPLICIT_ESCALATION', 'PARTICIPANT_FAILURE'];
