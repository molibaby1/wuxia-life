...
export const P25_ORDINARY_LIFE_PATHS: LifePathFixture[] = [
  ...
  },
  {
    ...
    player: { age: 46, martialPower: 38, reputation: 52, connections: 58 },
    flags: {
      route_merchant: true,
  ...
  },
  {
    ...
    player: { age: 42, martialPower: 42, reputation: 66, connections: 62 },
    flags: {
      ally_network: true,
  ...
  },
  {
    ...
    label: '农户·缺名望抉择',
    originId: 'farm_peasant',
    player: { age: 40, martialPower: 50, reputation: 55, connections: 50 },
  ...
  },
  {
    ...
    label: '学徒·缺商路',
    originId: 'town_apprentice',
    player: { age: 43, martialPower: 35, reputation: 48, connections: 45 },
  ...
  },
  {
    ...
    label: '跑堂·缺人脉网',
    originId: 'tavern_hand',
    player: { age: 41, martialPower: 40, reputation: 50, connections: 48 },
  ...
  },
  {
    ...
    label: '农户·巅峰窗口在',
    originId: 'farm_peasant',
    player: { age: 39, martialPower: 97, reputation: 78, connections: 22 },
