...
export const P25_MIXED_LIFE_PATHS: LifePathFixture[] = [
  {
    ...
    player: { age: 48, martialPower: 40, reputation: 55, connections: 65 },
  ...
  },
  {
    ...
    player: { age: 42, martialPower: 62, reputation: 55, connections: 35 },
  ...
  },
  {
    ...
    label: '商武一体·投资齐',
    originId: 'merchant_house',
    player: { age: 44, martialPower: 55, reputation: 50, connections: 50 },
  ...
  },
  {
    ...
    label: '巨贾行商·缺商路',
    originId: 'merchant_house',
    player: { age: 46, martialPower: 35, reputation: 50, connections: 60 },
  ...
  },
  {
    ...
    player: { age: 40, martialPower: 58, reputation: 52, connections: 30 },
  ...
  },
  {
    ...
    label: '商武一体·缺投资',
    originId: 'streetborn',
    player: { age: 43, martialPower: 52, reputation: 45, connections: 40 },
