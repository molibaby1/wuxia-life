...
- [Character / Relationship Product Contract v1](product/character-relationship-product-contract-design.md)：Human-accepted 的重要人物与人物关系产品语义；person-first、fact-driven relationship、恋爱/婚姻分离、no generic affinity；包含 Person Domain Authoring Contract v1.1（八项 Person Definition + actor classification + continuity/state escalation + Person ↔ Event mapping + unified validation + conformance examples）、shared-vs-character-specific promotion boundary 与明月人物纵切 v1 验证边界。Generic Person Instantiation 仍未授权；有限 Sex-Variant Person Archetype 由 PD-103 独立治理。
...
- [Parenthood / Family Life Product Contract v1](product/parenthood-family-life-product-contract-design.md)：Human-accepted 的 Parenthood 与家庭生活产品语义；Parenthood 独立于 Marriage、concrete child、no-child life valid、Parenthood ≠ Succession；旧 child lifecycle 语义降级为 legacy product semantics pending migration。
- [Content Authoring Workflow Contract v1](product/content-authoring-workflow-contract-design.md)：PD-106 Human-accepted 的 Gap Diagnosis、Human approval、语义验证与内容生产防扩张边界。
...
- [产品决策](governance/product-decisions.md)：长期 Product Decisions；Auto Evolution 当前方向重点见 PD-055、PD-062、PD-063；Character / Relationship、Sex-Variant Person Archetype、Parenthood、Generic Relationship Legacy Quarantine、Content Authoring Workflow、Person Domain Authoring consolidation、Life Milestone Domain & Feedback v2、Canonical Setback Occurrence / Resolution Ownership、Active Formal Random Trigger Retirement、Bounded Causal Attribution Evidence Handoff、Bounded Identity-Year Practice Duration 与 Sample-Line `currentGoal` Active-Objective Eligibility 的 current authority closure 见 PD-101 / PD-103 / PD-102 / PD-104 / PD-106 / PD-107 / PD-108 / PD-109 / PD-110 / PD-111 / PD-114 / PD-115。
